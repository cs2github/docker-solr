...
```
core=test
curl "http://localhost:8983/solr/admin/cores?action=CREATE&&name=$core&configSet=ext_solr_14_0_0&schema=english/schema.xml&instanceDir=/var/solr/data/cores/$core&dataDir=/var/solr/data/data/$core"
